...
func TestIsValidCapacityIOPS4CustomClass(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expectedError:  fmt.Errorf("invalid PVC size for custom class: <%v>. Should be in range [%d - %d]GiB", 5, utils.MinimumVolumeDiskSizeInGb, utils.MaximumBlockVolumeDiskSizeInGb),
		},
		{
		...
		},
		{
			...
			requestIops:    110,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid PVC size for custom class: <%v>. Should be in range [%d - %d]GiB", 18000, utils.MinimumVolumeDiskSizeInGb, utils.MaximumBlockVolumeDiskSizeInGb),
		},
		// {40, 79, 100, 2000}
		{
			testCaseName:   "Valid capacity IOPS",
		...
		},
		{
			...
			requestIops:    99,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid IOPS: <%v> for capacity: <%vGiB>. Should be in range [%d - %d]", 99, 60, 100, 2000),
		},
		// {80, 99, 100, 4000},
		{
			testCaseName:   "Valid capacity IOPS",
		...
		},
		{
			...
			requestIops:    99,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid IOPS: <%v> for capacity: <%vGiB>. Should be in range [%d - %d]", 99, 90, 100, 4000),
		},
		// {100, 499, 100, 6000}
		{
			testCaseName:   "Valid capacity IOPS",
		...
		},
		{
			...
			requestIops:    99,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid IOPS: <%v> for capacity: <%vGiB>. Should be in range [%d - %d]", 99, 300, 100, 6000),
		},
		// {500, 999, 100, 10000}
		{
			testCaseName:   "Valid capacity IOPS",
		...
		},
		{
			...
			requestIops:    99,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid IOPS: <%v> for capacity: <%vGiB>. Should be in range [%d - %d]", 99, 750, 100, 10000),
		},
		// {1000, 1999, 100, 20000}
		{
			testCaseName:   "Valid capacity IOPS",
		...
		},
		{
			...
			requestIops:    99,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid IOPS: <%v> for capacity: <%vGiB>. Should be in range [%d - %d]", 99, 1500, 100, 20000),
		},
		// {2000, 3999, 200, 40000}
		{
			testCaseName:   "Valid capacity IOPS",
		...
		},
		{
			...
			requestIops:    199,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid IOPS: <%v> for capacity: <%vGiB>. Should be in range [%d - %d]", 199, 3000, 200, 40000),
		},
		// {4000, 7999, 300, 40000},
		{
			testCaseName:   "Valid capacity IOPS",
		...
		},
		{
			...
			requestIops:    299,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid IOPS: <%v> for capacity: <%vGiB>. Should be in range [%d - %d]", 299, 6000, 300, 40000),
		},
		// {8000, 9999, 500, 48000}
		{
			testCaseName:   "Valid capacity IOPS",
		...
		},
		{
			...
			requestIops:    499,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid IOPS: <%v> for capacity: <%vGiB>. Should be in range [%d - %d]", 499, 9000, 500, 48000),
		},
		...
		},
		{
			...
			requestIops:    999,
			expectedStatus: false,
			expectedError:  fmt.Errorf("invalid IOPS: <%v> for capacity: <%vGiB>. Should be in range [%d - %d]", 999, 13000, 1000, 48000),
		},
	}
