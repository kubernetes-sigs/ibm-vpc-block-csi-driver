...
var messagesEn = map[string]util.Message{
	...
	"FailedToCreateGroupSnapshot": {
		Code:        "FailedToCreateGroupSnapshot",
		Description: "Failed to create a snapshot consistency group.",
		Type:        util.ProvisioningFailed,
		RC:          500,
		Action:      "Review the backend error and verify that all source volumes are eligible for a snapshot consistency group.",
	},
	"FailedToDeleteGroupSnapshot": {
		Code:        "FailedToDeleteGroupSnapshot",
		Description: "Failed to delete the snapshot consistency group with ID '%s'.",
		Type:        util.DeletionFailed,
		RC:          500,
		Action:      "Review the backend error and verify that the snapshot consistency group ID exists and is accessible.",
	},
	"GroupSnapshotRetrievalFailed": {
		Code:        "GroupSnapshotRetrievalFailed",
		Description: "Failed to retrieve the snapshot consistency group with ID '%s'.",
		Type:        util.RetrivalFailed,
		RC:          500,
		Action:      "Review the backend error and verify that the snapshot consistency group ID exists and is accessible.",
	},
	"GroupSnapshotNameLookupFailed": {
		Code:        "GroupSnapshotNameLookupFailed",
		Description: "Failed to retrieve the snapshot consistency group named '%s'.",
		Type:        util.RetrivalFailed,
		RC:          500,
	...
	"InvalidGroupSnapshotName": {
		...
		Type:        util.InvalidRequest,
		RC:          400,
		Action:      "Provide a non-empty name when creating or retrieving a snapshot consistency group.",
	},
